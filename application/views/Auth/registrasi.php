            ...
            <div class="login-content">
                ...
                <div class="lc-block toggled" id="l-login">
                    ...
                    <div class="lcb-form p-t-0">
                        <form action="<?= base_url('Auth/registrasi')?>"
                            method="post"
                            accept-charset="utf-8">
                            <?= $this->session->flashdata('message'); ?>
                            <div class="input-icon m-b-20">
                                <span class="input-icon"><i class="icon fa-solid fa-user"></i></span>
                                <div class="fg-line">
                            ...
                            <button type="submit"
                                class="btn btn-login btn-warning btn-float"><i
                                    class="zmdi zmdi-arrow-forward"></i></button>
                        </form> </div>
                    <div class="lcb-navigation">
                        <button id="oauth_login" type="button"
                            class="btn bgm-orange waves-effect"
